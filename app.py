...
def clean_api_key_for_header(key):
    ...
    # 唔可以 silently 刪字。
    # 如果有非 latin-1 字元，直接報錯，
    # 避免 API Key 被破壞後變成另一個錯誤。
    try:
        ...
        raise RuntimeError(
            "OPENROUTER_API_KEY 包含無法傳送的特殊字元。\n\n"
